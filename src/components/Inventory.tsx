    ...
    >
      <div className="max-w-[1400px] mx-auto">
        ...
        <div className="flex justify-between items-start mb-20">
          <div>
            <div className="text-accent text-[10px] uppercase tracking-[0.5em] font-bold mb-4">The Elite Luxury Collection by Rentmylife</div>
        ...
        {filteredCars.length === 0 && (
          <div className="py-40 text-center">
            <p className="text-black/20 uppercase tracking-[0.5em] text-xs">No matching vehicles found in our Atlanta collection.</p>
          </div>
        )}
      </div>
    </motion.div>
