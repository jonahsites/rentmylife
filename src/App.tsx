    ...
    <div className="relative bg-white font-sans selection:bg-accent selection:text-white overflow-x-hidden" id="home">
      ...
      <nav className="fixed top-8 left-1/2 -translate-x-1/2 z-100 flex items-center gap-2 px-2 py-2 bg-white/40 backdrop-blur-xl border border-black/10 rounded-full pointer-events-auto shadow-sm">
        <div className="flex items-center gap-3 px-6 py-2 border-r border-black/10">
          ...
          />
          <span className="text-xl font-brand text-black hidden md:block">Rentmylife</span>
        </div>
      ...
      >
        <div className="w-full max-w-[1600px] grid grid-cols-1 lg:grid-cols-[1.5fr_1fr] gap-12 items-end">
          ...
          <div className="relative z-20">
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-12 max-w-md border-t border-black/10 pt-12">
                <div>
                  <p className="text-[9px] uppercase tracking-widest text-black/30 mb-2">Curated Fleet</p>
                  <p className="text-sm font-medium leading-relaxed font-serif italic text-black/80">Automotive masterpieces selected for the discerning traveler.</p>
                </div>
                <div>
                  <p className="text-[9px] uppercase tracking-widest text-black/30 mb-2">Service Hubs</p>
                  <p className="text-sm font-medium leading-relaxed uppercase">Atlanta / Buckhead / Midtown / Savannah.</p>
                </div>
              </div>
            </motion.div>
          </div>
            ...
            >
              ...
              <div className="absolute bottom-8 left-8 right-8">
                <div className="flex justify-between items-end">
                  <div>
                    <p className="text-4xl font-brand mb-1 tracking-normal text-black">Rentmylife</p>
                    <p className="text-[10px] uppercase tracking-[0.4em] text-accent font-bold">Unrivaled Selection</p>
                  </div>
                  <MousePointer2 className="text-black/20 -rotate-12" size={32} />
                </div>
              </div>
            </motion.div>
          </div>
        ...
        <div className="w-full max-w-[1600px] mt-24 border-y border-black/5 grid grid-cols-2 lg:grid-cols-4 gap-0 divide-x divide-black/5">
          {specs.map((spec, i) => (
            <div key={i} className="px-10 py-12 flex flex-col gap-2 group cursor-crosshair hover:bg-black/5 transition-colors">
              <span className="text-[9px] font-mono text-black/20 tracking-widest uppercase">[{i.toString().padStart(2, '0')}] {spec.label}</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-32 items-center">
            <div className="order-2 lg:order-1">
              ...
              <div className="space-y-8 text-black/50 text-xl leading-relaxed font-light font-mono">
                <p>
                  &gt; RENTMYLIFE IS MORE THAN RENTALS.<br/>
                  &gt; WE ARE THE PREMIER OPERATORS OF ATLANTA & GEORGIA.
                </p>
      ...
      <footer id="contact" className="relative z-20 bg-white border-t border-black/5 px-10 pt-40 pb-20 md:px-16">
        <div className="max-w-[1400px] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-20 mb-32">
          <div className="col-span-1 lg:col-span-1">
            <div className="flex items-center gap-4 mb-12">
              ...
              />
              <div>
                <span className="text-2xl font-brand text-black leading-none block">Rentmylife</span>
        ...
        <div className="max-w-[1400px] mx-auto border-t border-black/5 pt-10 flex justify-between items-center">
          <p className="text-[9px] font-mono tracking-[0.4em] text-black/10 uppercase">© 2026 RENTMYLIFE_OPERATIONS // ALL_RIGHTS_RESERVED.</p>
